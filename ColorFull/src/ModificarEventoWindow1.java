...
public class ModificarEventoWindow1 extends javax.swing.JFrame {
   
    public ModificarEventoWindow1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tiempoJL.setOpaque(true);
        getContentPane().add(tiempoJL);
        tiempoJL.setBounds(20, 10, 310, 71);
    ...
    private void irActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_irActionPerformed
        ...
        int id = cc.ConsultarID(cc, String.valueOf(seleccion),fecha_inicioS);
